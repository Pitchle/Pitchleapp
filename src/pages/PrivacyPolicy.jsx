        ...
        <>
            <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8" >
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="mb-8">
                        <h2 className="text-xl font-bold text-gray-800 mb-4">1. Information Collection and Use</h2>
                    ...
                    <div className="text-gray-700 mb-8">
                        <h2 className="text-xl font-bold text-gray-800 mb-4">9. Contact Us</h2>
