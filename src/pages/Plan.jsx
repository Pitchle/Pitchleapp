...
const plan = {
    ...
    Business: [
        ...
        ['Create and join events worldwide', false, false, true, true],
        ['Renews', '', '', 'monthly', 'yearly'],
        ['Price', 'FREE', '$9.99', '$14.99/month', { mainPrice: '$149.99/year', subPrice: '12 months at $8.33/mo.\nSave 16.6%' }]
    ],
    Investor: [
        ...
        ['Create and join events worldwide', false, false, true, true],
        ['Renews', '', '', 'monthly', 'yearly'],
        ['Price', 'FREE', '$15.99', '$19.99/month', { mainPrice: '$199.99/year', subPrice: '12 months at $9.9/mo.\nSave 16.6%' }]
    ]
};
...
const Plan = () => {
    ...
    const renderCell = (cell, isHeader = false, isPriceRow = false, cellIndex = 0) => {
        ...
        if (typeof cell === 'object' && cell.mainPrice) {
            return (
                <div className={`text-center p-3 ${cellIndex === 0 ? 'text-black font-bold' : 'text-[#417dff] font-bold'} text-lg lg:text-xl`}>
