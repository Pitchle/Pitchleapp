    ...
    return (
        <>
            <div className={"flex justify-center"}>
                <div
                    className="p-4 lg:p-16 w-full lg:w-10/12 flex justify-center flex-col mx-auto space-y-10 lg:space-y-40">
                    <section className="flex flex-col mx-auto lg:flex-row items-center mt-6 lg:mt-16 justify-evenly">
                        <div className="lg:w-7/12 space-y-7 lg:space-y-12">
                            <h1 className="text-[40px] font-[700] lg:text-9xl text-center lg:text-start text-[#417DFF]">About
                                Company</h1>
                            <p className=" text-sm lg:text-2xl text-center lg:text-start">
                                ...
                                Unlike traditional social media, Pitchle is built for business, advocating for
                                eco-friendly
                                practices
                        ...
                        {[
                            {
                                ...
                                icon: (
                                    ...
                                    >
                                        <g clipPath="url(#clip0_559_3383)">
                                            <path
                                                d="M44.5 20.1667C47.9036 20.1667 51.1678 21.5188 53.5745 23.9255C55.9813 26.3322 57.3333 29.5964 57.3333 33C57.3333 36.4036 55.9813 39.6678 53.5745 42.0746C51.1678 44.4813 47.9036 45.8334 44.5 45.8334C41.0964 45.8334 37.8322 44.4813 35.4255 42.0746C33.0187 39.6678 31.6667 36.4036 31.6667 33C31.6667 29.5964 33.0187 26.3322 35.4255 23.9255C37.8322 21.5188 41.0964 20.1667 44.5 20.1667ZM18.8333 29.3334C20.8867 29.3334 24.0853 30.0689 25.7353 31.0589C25.1853 36.3022 26.4643 39.93 29.6176 44C27.7843 47.52 23.0867 51.3333 18.8333 51.3333C15.916 51.3333 13.1181 50.1744 11.0552 48.1115C8.99226 46.0486 7.83333 43.2507 7.83333 40.3334C7.83333 37.416 8.99226 34.6181 11.0552 32.5552C13.1181 30.4923 15.916 29.3334 18.8333 29.3334ZM70.1667 29.3334C73.084 29.3334 75.8819 30.4923 77.9448 32.5552C80.0077 34.6181 81.1667 37.416 81.1667 40.3334C81.1667 43.2507 80.0077 46.0486 77.9448 48.1115C75.8819 50.1744 73.084 51.3333 70.1667 51.3333C65.9133 51.3333 60.5686 48.1671 58.7353 44.6471C61.9308 40.5193 62.5065 35.6044 61.9706 30.4118C63.6206 29.4218 68.1133 29.3334 70.1667 29.3334ZM20.6667 66.9167C20.6667 59.3267 31.3367 53.1667 44.5 53.1667C57.6633 53.1667 68.3333 59.3267 68.3333 66.9167V73.3333H20.6667V66.9167ZM0.5 73.3333V67.8333C0.5 62.7367 9.87804 58.1879 19.2647 56.9412C17.1014 59.4346 15.3824 62.8704 15.3824 66.6471V73.3333H0.5ZM88.5 73.3333H73.6177V66.9167C73.6177 63.14 71.8986 59.4346 69.7353 56.9412C79.122 58.1879 88.5 62.7367 88.5 67.8333V73.3333Z"
                                                fill="#01BF74"
                                            />
                                        </g>
                                        <defs>
                                            <clipPath id="clip0_559_3383">
                            ...
                            <div key={index} className="p-6 text-start">
                                <div className="flex justify-start items-center my-4 space-x-5">
                                    ...
                                    <h3 className="font-bold mt-2 text-2xl lg:text-[40px]">{section.title}</h3>
                                </div>
                                <p className="text-start text-[16px] lg:text-[20px] font-[400] text-[#343434] lg:mt-8">
                                    {section.description}
                                </p>
                            </div>
                        ))}
                    </section>
                    <section className="flex flex-col py-10 lg:py-32 lg:flex-row  items-center justify-between">
                        <div className="lg:w-1/2 mt-6 w-full flex  lg:scale-105 justify-center lg:mt-0">
                            <div className={"flex items-center scale-110 lg:scale-125 lg:space-x-5"}>
                                <img
                        ...
                        <div className="lg:w-1/2 mt-20 p-1 lg:p-5 ms-0 lg:ms-20 lg:mt-0 space-y-8">
                            <h1 className="text-4xl lg:text-6xl font-bold text-[#417DFF]">Pitchle: Made for
                                Business</h1>
                            <p className="text-justify text-lg lg:text-[22px] ">
                                Social media today is largely focused on entertainment, leaving a gap in the business
                                sector.
                                There's a clear
                                need for a platform that addresses business and commerce opportunities with a
                                sophisticated,
                                contemporary
                                touch.
                            </p>
                            <br/>
                            <p className="text-justify text-lg lg:text-[22px] ">
                                That's how Pitchle was born – a unique social media platform dedicated exclusively to
                                empowering
                                small businesses to grow and succeed equitably. Through short videos, Pitchle helps
                                businesses
                                promote products,
                    ...
                    <section className="text-center py-32">
                        ...
                        <div
                            ...
                            {[
                                {
                                    title: 'Innovation',
                                    icon: <svg width="90" height="90" viewBox="0 0 88 88" fill="none"
                                               xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_627_2499)">
                                            <path
                                                d="M37.8535 27.3237C33.5696 30.5716 29.5161 34.1127 25.7221 37.9214C7.84554 55.798 -1.20589 75.7174 5.49468 82.4243C12.1953 89.1249 32.121 80.0672 49.9913 62.1969C53.8002 58.4009 57.3413 54.3452 60.589 50.0592"
                                                stroke="#417DFF" stroke-width="6" stroke-linecap="round"
                                                stroke-linejoin="round"/>
                                            <path
                                                d="M60.5887 50.0591C71.1298 64.0511 75.423 77.2134 70.2184 82.418C63.5115 89.1248 43.5921 80.0671 25.7155 62.1969C7.85154 44.314 -1.19989 24.4009 5.50068 17.694C10.7053 12.4957 23.8675 16.7889 37.8595 27.3237"
                                                stroke="#417DFF" stroke-width="6" stroke-linecap="round"
                                                stroke-linejoin="round"/>
                                            <path
                                                d="M34.709 50.0595C34.709 50.8931 35.0401 51.6925 35.6295 52.2819C36.2189 52.8713 37.0183 53.2024 37.8518 53.2024C38.6854 53.2024 39.4848 52.8713 40.0742 52.2819C40.6636 51.6925 40.9947 50.8931 40.9947 50.0595C40.9947 49.226 40.6636 48.4266 40.0742 47.8372C39.4848 47.2478 38.6854 46.9167 37.8518 46.9167C37.0183 46.9167 36.2189 47.2478 35.6295 47.8372C35.0401 48.4266 34.709 49.226 34.709 50.0595ZM50.4861 22.6915C48.5061 22.3458 48.5061 19.511 50.4861 19.1715C53.9841 18.5656 57.222 16.9304 59.786 14.475C62.3501 12.0196 64.1237 8.85548 64.8804 5.38696L64.9936 4.84011C65.421 2.89153 68.1993 2.87896 68.6393 4.82125L68.7901 5.45611C69.5791 8.90745 71.3696 12.049 73.937 14.4867C76.5045 16.9245 79.7345 18.5498 83.2221 19.159C85.2084 19.5047 85.2084 22.3584 83.2221 22.6978C79.7345 23.307 76.5045 24.9323 73.937 27.3701C71.3696 29.8078 69.5791 32.9493 68.7901 36.4007L68.6393 37.0355C68.1993 38.9841 65.421 38.9715 64.9936 37.023L64.8678 36.4761C64.1112 33.0076 62.3375 29.8434 59.7735 27.388C57.2095 24.9326 53.9716 23.2975 50.4736 22.6915H50.4861Z"
                                                stroke="#417DFF" stroke-width="6" stroke-linecap="round"
                                                stroke-linejoin="round"/>
                                        </g>
                                        <defs>
                                ...
                                {
                                    title: 'Collaboration',
                                    icon: <svg width="90" height="90" viewBox="0 0 82 81" fill="none"
                                               xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                },
                                {
                                    ...
                                    icon: <svg width="90" height="90" viewBox="0 0 88 88" fill="none"
                                        ...
                                        <g clip-path="url(#clip0_627_2541)">
                                            <path
                                                d="M3.48431 48.7669C2.38431 46.5669 1.52875 44.3364 0.917643 42.0752C0.306532 39.8141 0.000976563 37.5225 0.000976563 35.2002C0.000976563 28.3558 2.3232 22.6114 6.96764 17.9669C11.6121 13.3225 17.3565 11.0002 24.201 11.0002C28.051 11.0002 31.7176 11.8106 35.201 13.4312C38.6843 15.0519 41.6176 17.2971 44.001 20.1669C46.3843 17.2947 49.3176 15.0495 52.801 13.4312C56.2843 11.813 59.951 11.0027 63.801 11.0002C70.6454 11.0002 76.3899 13.3225 81.0343 17.9669C85.6788 22.6114 88.001 28.3558 88.001 35.2002C88.001 37.5225 87.6954 39.8141 87.0843 42.0752C86.4732 44.3364 85.6176 46.5669 84.5176 48.7669C83.8454 47.6058 83.051 46.5669 82.1343 45.6502C81.2176 44.7336 80.1482 44.0002 78.926 43.4502C79.476 42.0447 79.9038 40.6697 80.2093 39.3252C80.5149 37.9808 80.6676 36.6058 80.6676 35.2002C80.6676 30.4336 79.0482 26.4308 75.8093 23.1919C72.5704 19.953 68.5676 18.3336 63.801 18.3336C58.851 18.3336 55.0474 19.6939 52.3903 22.4146C49.7332 25.1352 46.9368 28.1749 44.001 31.5336C41.0676 28.1114 38.2724 25.0558 35.6153 22.3669C32.9582 19.678 29.1534 18.3336 24.201 18.3336C19.4343 18.3336 15.4315 19.953 12.1926 23.1919C8.95375 26.4308 7.33431 30.4336 7.33431 35.2002C7.33431 36.6058 7.48709 37.9808 7.79264 39.3252C8.0982 40.6697 8.52598 42.0447 9.07598 43.4502C7.85375 44.0002 6.78431 44.7336 5.86764 45.6502C4.95098 46.5669 4.15653 47.6058 3.48431 48.7669ZM0.000976563 80.6669L0.000976563 74.8919C0.000976563 72.203 1.36131 70.0483 4.08198 68.4276C6.80264 66.8069 10.3312 65.9978 14.6676 66.0002C15.4621 66.0002 16.226 66.0161 16.9593 66.0479C17.6926 66.0797 18.3954 66.1555 19.0676 66.2753C18.2121 67.4975 17.5704 68.8114 17.1426 70.2169C16.7149 71.6225 16.501 73.1197 16.501 74.7086L16.501 80.6669H0.000976563ZM22.001 80.6669L22.001 74.7086C22.001 70.7364 24.0335 67.528 28.0986 65.0836C32.1638 62.6391 37.4645 61.4169 44.001 61.4169C50.601 61.4169 55.9176 62.6391 59.951 65.0836C63.9843 67.528 66.001 70.7364 66.001 74.7086V80.6669H22.001ZM71.501 80.6669V74.7086C71.501 73.1197 71.303 71.6225 70.907 70.2169C70.511 68.8114 69.9145 67.4975 69.1176 66.2753C69.7899 66.153 70.478 66.0773 71.182 66.0479C71.886 66.0186 72.6034 66.0027 73.3343 66.0002C77.7343 66.0002 81.2788 66.8106 83.9676 68.4312C86.6565 70.0519 88.001 72.2055 88.001 74.8919V80.6669H71.501ZM14.6676 62.3336C12.651 62.3336 10.9252 61.6161 9.49031 60.1812C8.05542 58.7464 7.33675 57.0194 7.33431 55.0002C7.33431 52.9225 8.05298 51.1808 9.49031 49.7752C10.9276 48.3697 12.6534 47.6669 14.6676 47.6669C16.7454 47.6669 18.4871 48.3697 19.8926 49.7752C21.2982 51.1808 22.001 52.9225 22.001 55.0002C22.001 57.0169 21.2982 58.7439 19.8926 60.1812C18.4871 61.6186 16.7454 62.336 14.6676 62.3336ZM73.3343 62.3336C71.3176 62.3336 69.5919 61.6161 68.157 60.1812C66.7221 58.7464 66.0034 57.0194 66.001 55.0002C66.001 52.9225 66.7196 51.1808 68.157 49.7752C69.5943 48.3697 71.3201 47.6669 73.3343 47.6669C75.4121 47.6669 77.1538 48.3697 78.5593 49.7752C79.9649 51.1808 80.6676 52.9225 80.6676 55.0002C80.6676 57.0169 79.9649 58.7439 78.5593 60.1812C77.1538 61.6186 75.4121 62.336 73.3343 62.3336ZM44.001 58.6669C40.9454 58.6669 38.3482 57.5975 36.2093 55.4586C34.0704 53.3197 33.001 50.7225 33.001 47.6669C33.001 44.5502 34.0704 41.9384 36.2093 39.8312C38.3482 37.7241 40.9454 36.6694 44.001 36.6669C47.1176 36.6669 49.7308 37.7217 51.8403 39.8312C53.9499 41.9408 55.0034 44.5527 55.001 47.6669C55.001 50.7225 53.9474 53.3197 51.8403 55.4586C49.7332 57.5975 47.1201 58.6669 44.001 58.6669Z"
                                                fill="#417DFF"/>
                                        </g>
                                        <defs>
                                            <clipPath id="clip0_627_2541">
                                                <rect width="88" height="88" fill="white"/>
                                            </clipPath>
                                        </defs>
                                    </svg>
                                ...
                                <div key={index}
                                     className="py-6 lg:py-16 px-2 bg-gray-100 flex justify-center items-center flex-col space-y-8 rounded-3xl text-center">
                                    <span className={"scale-75 lg:scale-100"}>{value.icon}</span>
                                    <h3 className="font-bold text-xl lg:text-4xl">{value.title}</h3>
                                </div>
                            ))}
                        </div>
                    </section>
                    <section className="flex pt-10 pb-28 flex-col lg:flex-row lg:scale-110 items-center justify-center">
                        <div
                            className="lg:w-4/12 lg:me-10  lg:pb-16 flex items-center flex-col justify-center text-center lg:mt-0">
                            <img src="img/new_images/profile.png" alt="john"
                                 className="w-44 h-44 lg:w-72 lg:h-72 border-[7px] border-black rounded-full"/>
                            <h1 className={"mt-4 text-2xl font-bold lg:text-3xl lg:font-semibold"}>Jhon Pillpe</h1>
                        ...
                        <div className="lg:w-8/12  space-y-4 mt-8 lg:mt-0">
                            <p className=" text-[18px] font-[500] lg:text-4xl text-[##343434] lg:font-[500] lg:leading-10 text-center italic">
                                ...
                                <br/>
                                <br/>
                                Pitchle aims to be a game-changing tech leader <br/>
                                in business and commerce, <br/>
                                empowering small businesses and independent <br/> professionals to thrive responsibly.
                                ”
                            </p>
                        </div>
                    </section>
                        ...
                        <div className="w-full mx-auto">
                            <div className="flex flex-col justify-between md:flex-row items-start gap-1 lg:gap-8 mb-12">
                                <div className="w-full md:w-6/12">
                                    <h1 className="text-4xl lg:text-6xl font-bold mb-8">We Care</h1>
                                    <p className="text-lg mb-4">Pitchle is more than a platform. We're the partner your
                                        business
                                    ...
                                    <p className="text-lg mb-8 lg:mb-0">Every business deserves the chance to shine, and
                                        we're
                                        here to make
                                        that happen.</p>
 29.6813 75.8813C28.1242 77.2576 26.3055 78.0972 24.2253 78.4003L7.81699 80.8753ZM57.7753 78.4003C55.6975 78.0948 53.8801 77.2551 52.323 75.8813C50.7659 74.5076 49.65 72.8417 48.9753 70.8837L45.8587 61.167C45.0031 58.417 45.1718 55.7281 46.3647 53.1003C47.5575 50.4726 49.4972 48.6392 52.1837 47.6003L49.342 38.617C48.5475 36.1115 48.6245 33.6523 49.573 31.2397C50.5214 28.827 52.125 26.9778 54.3837 25.692L55.667 24.9587C56.5837 24.4698 57.5309 24.3622 58.5087 24.636C59.4864 24.9098 60.2198 25.5062 60.7087 26.4253L75.192 53.742C75.4976 54.3531 75.9412 54.8273 76.523 55.1647C77.1048 55.502 77.7305 55.6695 78.4003 55.667C79.2559 55.667 79.9587 55.942 80.5087 56.492C81.0587 57.042 81.3337 57.7448 81.3337 58.6003V60.067C81.3337 60.9226 81.0587 61.6253 80.5087 62.1753C79.9587 62.7253 79.2559 63.0003 78.4003 63.0003C76.3837 63.0003 74.5051 62.4662 72.7647 61.398C71.0242 60.3298 69.6639 58.9083 68.6837 57.1337L56.4003 34.0337C56.2781 34.4003 56.217 34.7976 56.217 35.2253C56.217 35.6531 56.2781 36.0503 56.4003 36.417L63.367 58.417C63.6725 59.3948 63.5955 60.3273 63.136 61.2147C62.6764 62.102 61.959 62.6972 60.9837 63.0003C60.0083 63.3035 59.0758 63.2277 58.186 62.773C57.2962 62.3183 56.701 61.5997 56.4003 60.617L54.4753 54.567C53.6809 54.9948 53.1309 55.6059 52.8253 56.4003C52.5198 57.1948 52.5198 58.0198 52.8253 58.8753L55.942 68.592C56.1864 69.2642 56.569 69.8301 57.0897 70.2897C57.6103 70.7492 58.2055 71.0389 58.8753 71.1587L75.3753 73.6337C76.1698 73.7559 76.7968 74.1385 77.2563 74.7813C77.7159 75.4242 77.8833 76.1417 77.7587 76.9337L77.5753 78.4003C77.4531 79.1948 77.0559 79.8365 76.3837 80.3253C75.7114 80.8142 74.9781 80.9976 74.1837 80.8753L57.7753 78.4003Z"
                                            fill="white" stroke="#417DFF" stroke-width="3"
                                            mask="url(#path-1-inside-1_261_303)"/>
                                    </svg>

                                    <h2 className="text-2xl lg:text-[30px]  mb-4 mt-4 font-bold ">Supporting Small
                                        Businesses</h2>
                                    <p>We empower small businesses by connecting them with new opportunities, partners,
                                        and
                                        customers.</p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div className="p-6 bg-gray-100 rounded-3xl">
                                    ...
                                    <h2 className="text-xl lg:text-[30px]  mb-4 mt-4 font-bold">Inclusivity & Equal
                                        Opportunities</h2>
                                ...
                                <div className="p-10 bg-[#417DFF] text-white rounded-3xl">
                                    ...
                                    <h2 className="text-xl lg:text-[30px]  mb-4 mt-4 font-bold">Sustainability & Eco
                                        Trends</h2>
                                ...
                                <div className="p-10 bg-gray-100 rounded-3xl">
                                    ...
                                    <h2 className="text-xl lg:text-[30px]  mb-4 mt-4 font-bold ">Helping Businesses
                                        Grow</h2>
                                    <p>Our platform provides tools for promotion, networking, and scaling
                                        businesses.</p>
                                </div>
                            </div>
                        </div>
