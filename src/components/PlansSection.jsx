  ...
  return (
    <section className=" py-40 lg:py-52 space-y-20 lg:space-y-32 px-0 md:px-16  text-center">
      ...
      <div className="w-full  mx-auto mb-12">
        ...
        <div className="hidden lg:grid grid-cols-3 gap-15">
          {plansData.map((plan, index) => (
            <div
              key={index}
              className="bg-gray-100 scale-110 my-10 space-y-5 p-14 rounded-2xl shadow-sm transition-transform transform hover:scale-105 cursor-pointer"
            >
