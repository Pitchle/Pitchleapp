    ...
    const faqs = [
        {
            ...
            answer: "<span translate='no'>Pitchle</span> is a business-oriented platform designed for individuals seeking partners for new projects or startups, as well as entrepreneurs and startups looking for investors. It also provides an option for those interested in selling or transferring their businesses. The app facilitates connections through short video pitches of 30 seconds (free) or up to 60 seconds (paid), with the option to add a different background behind the video for a fee."
        },
        {
            question: "Who can use <span translate='no'>Pitchle</span> app?",
            answer: "<span translate='no'>Pitchle</span> is designed for individuals, entrepreneurs, startups, and businesses of all sizes and sectors who are seeking partnerships, investments, or opportunities to sell or transfer their businesses."
        },
        {
        ...
        {
            question: "What types of videos are allowed on <span translate='no'>Pitchle</span> app?",
            answer: "<span translate='no'>Pitchle</span> is strictly business-oriented, and only videos related to pitches, partnership opportunities, investment proposals, or business sales are permitted. Any other types of videos that do not align with the app's purpose should be reported and will be subject to removal."
        },
        {
        ...
        },
        {
            ...
            answer: "<span translate='no'>Pitchle</span> prioritizes the security and privacy of user information. Users have control over their privacy settings and can choose who can view their profiles and pitches."
        },
        {
            question: "Can I use <span translate='no'>Pitchle</span> app for networking purposes outside of business?",
            answer: "While <span translate='no'>Pitchle</span> app is primarily focused on business-related activities, users may also find networking opportunities and connections that extend beyond strictly business matters. However, the primary purpose of the app is to facilitate professional partnerships, investments, and business transactions."
        },
        {
        ...
        {
            question: "Is <span translate='no'>Pitchle</span> app available worldwide?",
            answer: "Yes, <span translate='no'>Pitchle</span> app is accessible globally, allowing users from different countries and regions to connect and explore business opportunities on a global scale."
        }
    ];
                ...
                <div className="mt-8 space-y-8 lg:mt-12">
                    {faqs.map((faq, index) => (
                        <div key={index} className="p-8 bg-[#01be74] rounded-lg dark:bg-gray-800">
                            ...
                            >
                                <h1 className="font-semibold text-xl text-white dark:text-white" dangerouslySetInnerHTML={{ __html: faq.question }} />
                            ...
                            {expandedItems[index] && (
                                <p className="mt-6 text-lg text-start text-white dark:text-gray-300" dangerouslySetInnerHTML={{ __html: faq.answer }} />
                            )}
                        </div>
                    ))}
                </div>
