            ...
            <div className={"w-full sticky top-0 z-30 flex justify-center items-center text-white"} >
                <div className={"w-11/12 my-2 bg-[#450073] grid grid-cols-3 px-8 py-2 md:py3 rounded-full"}>
                    <ul className="hidden lg:flex space-x-10 items-center"> {/* Show only in desktop view */}
                        ...
                        <li className="c-underline text-2xl font-bold cursor-pointer"><ScrollLink to="plans" smooth={true} duration={800}>Plans</ScrollLink></li>
                    </ul>
                    ...
                    <div className={"text-center my-auto text-4xl md:text-5xl -ms-4 md:ms-0 font-bold cursor-pointer"}><ScrollLink to="home" smooth={true} duration={800}>Pitchle</ScrollLink></div>
