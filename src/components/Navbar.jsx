        ...
        <>
            <div className={"w-full sticky top-0 z-30 flex justify-center items-center text-white"} >
                <div className={"w-11/12 my-2 bg-[#01be74] grid grid-cols-3 px-8 py-2 md:py3 rounded-full"}>
                    <ul className="hidden lg:flex space-x-10 items-center"> {/* Show only in desktop view */}
                        <li className="relative group">
                            ...
                            <ul className="absolute left-[0.2] mt-1 w-48 bg-white shadow-md rounded-md p-2 space-y-2 hidden group-hover:block">
                                ...
                                <li className="text-black cursor-pointer"><Link to={"/story"}>Our Story</Link></li>
                    ...
                    <div className={"text-center my-auto text-4xl md:text-5xl -ms-4 md:ms-0 font-bold cursor-pointer"}> <Link to={"/"}> Pitchle </Link></div>
