        ...
        <div className={"flex  justify-center"}>
            <footer className={`${bgColor} w-full  m-2 py-10 p-4 text-[#343434]  lg:m-4 lg:px-10 rounded-3xl mt-10`}>
                <ToastContainer
                    ...
                    pauseOnHover
                />
                <div className={" w-11/12 mx-auto py-10 lg:p-0 "}>
                    {/* Row 1: Brand (left) + Newsletter (right) */}
                    <div className="flex flex-col md:flex-row md:justify-between gap-2">
                        {/* Brand */}
                        <div className="flex -mt-10 flex-col justify-center items-center md:items-start">
                            <div className="flex items-center space-x-3">
                                <img
                                    src="/img/logo/logo.png"
                                    alt="Pitchle Logo"
                                    className=" w-22 h-20 scale-105 rounded-full"
                                />
                                <h2 className="text-4xl lg:-mt-3 font-semibold">Pitchle</h2>
                            </div>
                            <p className="lg:text-2xl text-lg mt-4  font-[500] text-center md:text-left">
                        ...
                        {/* Newsletter */}
                        <div className="w-full  lg:w-5/12 my-10 lg:my-12">
                            <h3 className="text-xl lg:text-[32px] lato-font text-center md:text-left mb-8 lg:mb-2">
                            ...
                            <div className="flex flex-col w-full mx-auto mt-7 justify-center md:justify-start">
                                <div className="flex">
                                    <input
                                        type="email"
                                        value={email}
                                        ...
                                        className="border-2 border-blue-500 placeholder-[black] rounded-full px-4 py-3 lg:py-5 focus:outline-none w-44 lg:w-8/12"
                                    />
                                    <button
                                        onClick={handleSubscribe}
                                        className="ml-3 bg-[#417DFF] w-5/12 lg:w-3/12 text-lg lg:text-2xl text-white px-6 py-2 rounded-full hover:bg-blue-600 transition"
                                    >
                                        Subscribe
                                    </button>
                                </div>
                    ...
                    <div className={"flex justify-end mb-10 mt-7"}>
                        <div className={"flex w-full lg:w-6/12  justify-end"}>
                            <div
                                className=" w-full lg:w-10/12 grid grid-cols-2 px-4 md:grid-cols-3 gap-8 lg:gap-0 mt-10">
                                {/* Company */}
                                <div>
                                    <h4 className="font-bold text-xl lg:text-4xl mb-7">Company</h4>
                                    <ul className="space-y-2 mt-3 text-sm">
                                        {[
                                            ...
                                            <li key={item.name}>
                                                <Link
                                                    to={item.path}
                                                    className={`relative group text-md lg:text-[20px] transition duration-300 ${
                                ...
                                {/* Legal */}
                                <div>
                                    <h4 className="font-bold text-xl  lg:text-4xl mb-7">Legal</h4>
                                ...
                                <div className={"col-span-2 md:col-span-1 "}>
                                    <h4 className="font-bold text-xl lg:text-4xl mb-7">Connect</h4>
                                    <a
                                        href="mailto:contact@pitchleapp.com"
                                        className="text-md lg:text-[20px] font-[500] mt-3 mb-2 hover:underline"
                                    >
                                    ...
                                    <div className="flex mt-4 space-x-1">
                                        <a href="https://www.linkedin.com/" target="_blank" rel="noopener noreferrer">
                                            <div
                                                className="bg-[#01BF74]  w-14 h-14 flex items-center justify-center rounded-full">
                                        ...
                                        <a href="https://play.google.com/store/apps/details?id=com.pitchle.pitchleApp"
                                           target="_blank" rel="noopener noreferrer">
                                            <div
                                                className="bg-[#01BF74] w-14 h-14 flex items-center justify-center rounded-full">
                                                <FaGooglePlay size={32} className="text-white"/>
                                            </div>
                                        </a>
                                    </div>
                                </div>
