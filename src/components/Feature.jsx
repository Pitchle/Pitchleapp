                ...
                <div className="lg:w-8/12 w-full mx-auto flex flex-col space-y-8 justify-center ps-1">
                    <div className="w-11/12 flex flex-col md:flex-row space-x-5 lg:space-x-72  px-2 md:px-8 lg:px-0 justify-center">
                        <div
                            ...
                            className="w-4/12 zoom-effect flex  ms-10 lg:ms-20 justify-center item-center z-10 flex-col rounded-full bg-[#3d0e6d] text-white h-56 w-56 relative group transition duration-300 ease-in-out">
                        ...
                        <div
                            ...
                            <div
                                className="absolute rounded-2xl inset-0 bg-[#3d0e6d] h-[20rem] lg:w-[28rem] w-[19rem]  text-white opacity-0 group-hover:opacity-100 flex justify-center items-center transition-opacity duration-300">
                    ...
                    <div className="w-11/12 flex justify-between my-10 zoom-effect px-2 md:px-8 lg:px-0 flex-col md:flex-row">
                        <div className="w-4/12 flex ms-24 justify-center item-center flex-col text-center rounded-full bg-[#3d0e6d] text-white h-[15rem] w-[15rem] relative group transition duration-300 ease-in-out">
                        ...
                        <div className="w-4/12 flex justify-center mt-0 lg:-mt-32 item-center zoom-effect flex-col text-center rounded-full bg-[#3d0e6d] text-white h-[15rem] w-[15rem] relative group transition duration-300 ease-in-out">
                        ...
                        <div className="w-4/12 flex justify-center ms-10 mt-10 lg:ms-20 item-center zoom-effect flex-col text-center rounded-full bg-[#3d0e6d] text-white h-[15rem] w-[15rem] relative group transition duration-300 ease-in-out">
