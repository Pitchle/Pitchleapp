        ...
        <>
            ...
            <div className="w-full my-16">
                <div className="lg:w-8/12 w-full mx-auto flex flex-col justify-center ps-1">
                    <div className="w-11/12 flex flex-col md:flex-row items-center space-y-4 px-2 md:px-8 lg:px-0 justify-between">
                        <div
                            data-aos="fade-right"
                            data-aos-offset="100"
                            data-aos-duration="500"
                            data-aos-easing="ease-in-sine"
                            className="w-4/12 zoom-effect flex justify-center item-center z-10 flex-col text-center rounded-full bg-gradient-to-r from-[#450073] to-[#7200bf] text-white h-56 w-56 relative group transition duration-300 ease-in-out">
                            <h3 className="w-full text-4xl font-bold my-4">Video Pitches</h3>
                            <div className="absolute rounded-2xl inset-0 bg-gradient-to-r from-[#450073] to-[#7200bf] transition duration-500 ease-in-out h-[20rem] w-[18rem] text-white  opacity-0 group-hover:opacity-100 flex justify-center items-center duration-2000 ease-in-out">
                        ...
                        <div
                            ...
                            data-aos-duration="500"
                            data-aos-easing="ease-in-sine"
                            className="w-4/12 flex zoom-effect justify-center item-center p-4 flex-col text-center rounded-full bg-gradient-to-r from-[#7200bf] to-[#450073] text-white h-64 w-64 relative group transition duration-300 ease-in-out">
                    ...
                    <div
                        ...
                        <div className="w-4/12 flex mx-auto justify-center item-center flex-col text-center rounded-full text-white h-[15rem] w-[15rem]">
                            <img src="/img/logo/logo.png" alt="logo" className="rotate-image scale-ani"/>
                        </div>
                    </div>
                    <div className="w-11/12 flex justify-between zoom-effect px-2 md:px-8 lg:px-0 items-center space-y-4 flex-col md:flex-row">
                        ...
                        <div className={"dotted-line hidden lg:block"}></div>
                        <div className="w-4/12 flex justify-center item-center zoom-effect flex-col text-center rounded-full bg-gradient-to-r from-[#450073] to-[#7200bf] text-white h-[15rem] w-[15rem] relative group transition duration-300 ease-in-out">
