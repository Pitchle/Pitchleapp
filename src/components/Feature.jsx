                ...
                <div className="lg:w-8/12 w-full mx-auto flex flex-col space-y-8 justify-center ps-1">
                    <div className="w-11/12 flex flex-col md:flex-row space-x-5 lg:space-x-72  px-2 md:px-8 lg:px-0 justify-center">
                        <div
                            ...
                            className="w-4/12 zoom-effect flex  ms-24 lg:ms-20 justify-center item-center z-10 flex-col rounded-full bg-[#3d0e6d] text-white h-40 w-40 lg:h-56 lg:w-56 relative group transition duration-300 ease-in-out">
                        ...
                        <div
                            ...
                            data-aos-duration="500"
                            data-aos-easing="ease-in-sine"
                            className="w-4/12 flex zoom-effect justify-center mt-8 item-center p-4 flex-col rounded-full bg-[#3d0e6d] text-white w-40 h-40 lg:h-64 lg:w-64 relative group transition duration-300 ease-in-out">
                    ...
                    <div className="w-fullS flex justify-between my-10 zoom-effect px-2 md:px-8 lg:px-0 flex-col md:flex-row">
                        <div className="w-4/12 flex ms-40 justify-center item-center flex-col text-center rounded-full bg-[#3d0e6d] text-white h-40 w-40 lg:h-[15rem] lg:w-[15rem] relative group transition duration-300 ease-in-out">
                        ...
                        <div className="w-4/12 flex justify-center ms-5 lg:ms-0 mt-0 lg:-mt-32 item-center zoom-effect flex-col text-center rounded-full bg-[#3d0e6d] text-white w-40 h-40  lg:h-[15rem] lg:w-[15rem] relative group transition duration-300 ease-in-out">
                        ...
                        <div className="w-4/12 flex justify-center ms-24 mt-10 lg:ms-20 item-center zoom-effect flex-col text-center rounded-full bg-[#3d0e6d] text-white h-40 w-40 lg:h-[15rem] lg:w-[15rem] relative group transition duration-300 ease-in-out">
